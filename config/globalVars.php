...
define('RELEASE', 4);
define('ASSET_RELEASE', '93'); // Change asset release on every css/js change
define('RELEASE_VESION', 'v0.1.6');
define('RELEASE_VERSION', 'v0.1.6');
