...
define('RELEASE', 4);
define('ASSET_RELEASE', '95'); // Change asset release on every css/js change
define('RELEASE_VESION', 'v0.1.12');
define('RELEASE_VERSION', 'v0.1.12');
