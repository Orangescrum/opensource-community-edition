...
define('RELEASE', 4);
define('ASSET_RELEASE', '94'); // Change asset release on every css/js change
define('RELEASE_VESION', 'v0.1.10');
define('RELEASE_VERSION', 'v0.1.10');
