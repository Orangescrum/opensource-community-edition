...
define('RELEASE', 4);
define('ASSET_RELEASE', '92'); // Change asset release on every css/js change
define('RELEASE_VESION', 'v0.1.3');
define('RELEASE_VERSION', 'v0.1.3');
