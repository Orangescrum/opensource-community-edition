<?php echo $this->Form->create(null, array('id' => 'add_description')); ?>
...
<div class="modal-body popup-container">
    ...
    <div class="form-group form-group-lg is-empty  label-floating">
        ...
        <?php echo $this->Form->textarea('description', array('id' => 'description', 'class' => 'form-control expand hideoverflow  des-label', 'data-desc' => $description, 'rows' => '1', 'placeholder' => '','value'=>$description)); ?>
