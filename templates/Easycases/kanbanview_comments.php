<style>
    ...
    #prj_btn_edit .btn_cmn_efect{font-size:14px;color:#2e2e2e}
    ...
    <div class="modal-content">
        ...
        <div class="modal-body popup-container mtop20">
            ...
            <div id="inner_project_temp_edit" class="project-templete-pop">
				...
				<?php if($is_client){ ?>
                <span style="font-size: 14px;color: #2e2e2e;margin-top: -23px;margin-bottom: 18px;display: block;"><?php echo $comments_cnt; ?> comment<?php if($comments_cnt > 1){ ?>s<?php } ?> for you!</span>
				<?php } ?>
