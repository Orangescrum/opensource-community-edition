...
<div class="modal-body popup-container">
    <div class="data-scroll user_pdt">
        ...
        <div class="">
            ...
            ?>
                <div>
                <label class="control-label" for="filter_name"><span><?php echo __('Select Project'); ?></span></label>
                    <select class="select form-control" name="new_project" id="new_project_cp" onchange="rmverrmsg();">
                        <?php
                        foreach ($projects as $proj) {
                            if ($proj['id'] == trim($project_id)) {
                        ...
                        ?>
                            ...
                            ?>
                                <option value="<?php echo $proj['id']; ?>" <?php if ($proj['id'] == $project_id) { ?>selected="selected" <?php } ?>><?php echo ucwords($this->Format->shortLength($proj['name'], 75)); ?></option>
                            <?php } ?>
                        <?php } ?>
                    </select>
