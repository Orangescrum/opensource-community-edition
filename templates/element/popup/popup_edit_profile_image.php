        ...
        <div class="modal-body popup-container">
            <div id="inner_prof_img">
                <?= $this->Form->create(null, [
                    'type' => 'file',
                    'url' => ['controller' => 'Users', 'action' => 'showPreviewImg'],
                    'id' => 'file_upload1',
                    'class' => 'upload applied file_upload',
                ]) ?>

                <div class="customfile" id="inputfileid" style="display:none;">
                    <?= $this->Form->button(__('Browse'), ['class' => 'customfile-button', 'type' => 'button']) ?>
                    <span aria-hidden="true" class="customfile-feedback"><?= __('Select your profile image'); ?>...</span>
                    <?= $this->Form->control('User.photo', ['type' => 'file', 'label' => false, 'class' => 'fileupload customfile-input', 'id' => 'upldphoto']) ?>
                </div>

                <table cellpadding="0" cellspacing="0" class="col-lg-12">
                    <tr>
                        <td>
                            <div class="profile-img-note"><?= __('Drag and set the box on the area you want to crop'); ?>.</div>
                            <br />
                            ...
                            <?= $this->Form->hidden('User.photo', ['id' => 'imgName']) ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <?= $this->Form->hidden('x',['id' => 'x']) ?>
                            <?= $this->Form->hidden('y',['id' => 'y']) ?>
                            <?= $this->Form->hidden('w',['id' => 'w']) ?>
                            <?= $this->Form->hidden('h',['id' => 'h']) ?>
                        </td>
                    </tr>
                </table>
