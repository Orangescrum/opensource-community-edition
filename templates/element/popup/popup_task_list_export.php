            ...
            <div class="modal-body popup-container">
                <div class="row">
                    ...
                    <div class="col-lg-12 mbtm15 export-fields">
                        ...
                        <div class="checkbox custom-checkbox pop-task-type-check">
                            <label for="exp_parent">
                                <input id="exp_parent" type="checkbox" value="task_parent" class="tsk_exp_chkbx" checked="checked" />
                                <span class="oya-blk">
                                    <?php echo __('Parent'); ?>
                                </span>
                            </label>
                        ...
                        <div class="checkbox custom-checkbox pop-task-type-check">
                            <label for="exp_label">
                                <input id="exp_label" type="checkbox" value="Label" class="tsk_exp_chkbx" />
                                <span class="oya-blk">
                                    <?php echo __('Label'); ?>
                                </span>
                            </label>
                        </div>
                        <div class="checkbox custom-checkbox pop-task-type-check exp_epic">
                            <label for="exp_epic">
                                <input id="exp_epic" type="checkbox" value="epic" class="tsk_exp_chkbx" />
                                <span class="oya-blk">
                                    <?php echo __('Epic'); ?>
                                </span>
                            </label>
                        </div>
                        <div class="checkbox custom-checkbox pop-task-type-check exp_task_link">
                            <label for="exp_task_link">
                                <input id="exp_task_link" type="checkbox" value="tasklink" class="tsk_exp_chkbx" />
                                <span class="oya-blk">
                                    <?php echo __('Linked Task'); ?>
                                </span>
                            </label>
                        </div>
                        <div class="cb"></div>
