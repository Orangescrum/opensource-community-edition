<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body popup-container">
            <div class="row">
                <div class="col-lg-12">
                    <?php echo $this->Form->create(null, ['url' => ['controller' => 'SearchFilters','action' => 'saveFilter'],'name' => 'projectadd', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal','id'=>'filter-edit-popup', 'autocomplete' => 'off']); ?>
                    <input type="hidden" name="data[SearchFilter][user_id]" id="save-filter-user-id"  value="<?php print SES_ID;?>" />
                    ...
                    <input type="hidden" name="data[SearchFilter][CUSTOM_FIELD]" id="flt-CUSTOM_FIELD-popup"  value="" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <label class="control-label" for="filter_name"><span><?php echo __('Filter name'); ?></span></label>
