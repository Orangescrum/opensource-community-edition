<div class="modal-body popup-container">
    ...
    <?php echo $this->Form->create(null, ['url' => '/users/add_customer','name' => 'frm_add_customer','id' => 'frm_add_customer']); ?>
    ...
    <div class="data-scroll new_customer">
        ...
        <div class="form-group label-floating">
            <label class="control-label" for="customer_code"><?php echo __("Customer's Code");?></label>
            <?php echo $this->Form->text('customer_code', array('value' => '', 'class' => 'form-control', 'id' => 'customer_code', 'placeholder' => "",'minlength' => '4', 'maxlength' => '10')); ?>
        </div>
        <div class="form-group label-floating custom-task-fld assign-to-fld cstmpop-select-label labl-rt add_new_opt select_placeholder" id="sel_cust_currency">
              <label class="control-label" for="cust_currency"><?php echo __("Cust Currency");?></label>
            <?php echo $this->Form->control('cust_currency', [ 'type'=>'select', 'label' => false, 'div' => false, 'class'=>'select2', 'id'=> 'cust_currency', 'options' => $this->Format->currency_opts(), 'empty' => false, 'data-dynamic-opts' => 'true']);?>
        </div>
        <div class="custom-task-fld assign-to-fld cstmpop-select-label labl-rt add_new_opt select_placeholder" id="sel_cust_currency" style ="display:none;">
            <?php echo $this->Form->input('role_id', array('options' => $rolelist, 'empty' => false, 'class' => 'selecr2', 'id' => 'select_role_customer', 'placeholder' => __("Assign Role"), 'data-dynamic-opts' => 'true', 'label' => false)); ?>
        </div>
