<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="add_task_temp_name ellipsis-view add_new_subtask_title" style="max-width: 85%;"><?php echo __('Subtask'); ?></h4>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-xs-12 select2__wrapper">
                    <div class="form-group label-floating">
                        ...
                        <input type="hidden" id="popup_task_type_sub" value="" />
                    ...
                    <div class="select2__wrapper w_b task-field-2">
                        <div class="custom-task-fld title-fld top-tsk-ttl ct-title">
                            <div class="field_wrapper nofloat_wrapper">
                                <input id="CS_title_pop" type="text" maxlength='240' />
                                <div class="field_placeholder mark_mandatory"><span class="add_new_subtask_title_input"><?php echo __('Task Title'); ?></span></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mtop10">
                ...
                <div class="col-lg-6 col-sm-6 col-xs-6 w_a task-field-4 task-field-all custom-task-fld task-type-fld labl-rt task_type cstm-drop-pad <?php if (!$this->Format->isAllowed('Change Other Details of Task', $roleAccess)) { ?>no-pointer<?php } ?>">
                    <div class="select_field_wrapper mark_mandatory">
                        <select class="subtsktyp-select form-control floating-label" placeholder="<?php echo __('Task Type'); ?>" data-dynamic-opts=true onchange="changeTypeId(this)" data-type="subtask-popup" id="inline-add-tsks">
                            <?php
                            foreach ($GLOBALS['TYPE'] as $k => $v) {
                                if (strtolower($v['Type']['name']) != 'epic') {
            ...
            <div class="row mtop20">
                ...
                <div class="col-md-4 mtop15  <?php if (!$this->Format->isAllowed('Est Hours', $roleAccess)) { ?>no-pointer<?php } ?>">
                    <div class="field_wrapper nofloat_wrapper" rel="tooltip" title="<?php echo __('You can enter time as 1.5  (that  mean 1 hour and 30 minutes)'); ?>.">
                        <input type="text" onkeypress="return numeric_decimal_colon(event),mins_validation(this)" id="sub_estimated_hours" name="data[Easycase][estimated_hours]" maxlength="5" class="ttfont est check_minute_range" value="<?php echo $taskdetails['estimated_hours'] ?? ''; ?>" placeholder="hh:mm" onchange="mins_validation(this);setSubStartDueDt();">
