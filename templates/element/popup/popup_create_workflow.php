<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <?php echo $this->Form->create(null, ['url' => ['controller' => 'Projects', 'action' => 'manageTaskStatusGroup'], 'id' => 'workflowForm', 'onsubmit' => "return validateWorkFlow();"]); ?>
            ...
            <div class="modal-footer">
                ...
                <span id="create_wloader" style="display:none;">
                    ...
                    <span class="fl hover-pop-btn">
                        <input type="submit" id="newworkflow_btn_create" value="<?php echo __('Add');?>" name="add" class="btn btn_cmn_efect cmn_bg btn-info cmn_size" />
                    </span>
                </span>
