            ...
            <span class="fl">
                ...
                <span class="fl cancel-link"><button type="reset" class="btn btn-default btn_hover_link cmn_size" data-dismiss="modal" onclick="closePopup();"><?php echo __('Cancel');?></button></span>
                    <span class="fl hover-pop-btn">
                        <input type="button" id="newworkflow_btn_bookmark_create" value="<?php echo __('Add');?>" name="add" class="btn btn_cmn_efect cmn_bg btn-info cmn_size" onclick="createBookmark();"/>
                    </span>
            </span>
                    <div class="cb"></div>
                </div>
