            ...
            <div class="modal-body popup-container">
                <div id="inner_label">
                    ...
                    <div class="form-group label-floating">
                        ...
                        <input type="text" value="" class="form-control" style="margin-bottom: 28px !important;" name="title" id="edit_bookmark_title"/>
            ...
            <span id="bmbtn">
                <span class="fl cancel-link"><button type="reset" class="btn btn-default btn_hover_link cmn_size" data-dismiss="modal" onclick="closePopup();"><?php echo __('Cancel');?></button></span>
                    <span class="fl hover-pop-btn">
                        <input type="button" id="newworkflow_btn_bookmark_edit" value="<?php echo __('Update');?>" name="add" class="btn btn_cmn_efect cmn_bg btn-info cmn_size"onclick="editAjaxBookmark();" />
                    </span>
            </span>
                    <div class="cb"></div>
                </div>
