    ...
    <div class="modal-content">
        ...
        <div id="inner_project_list_export" class="mtop10">
          ...
          <div class="checkbox custom-checkbox pop-task-type-check">
					...
					<div class="checkbox custom-checkbox pop-task-type-check">
							<label for="exp_projectManager">
									<input id="exp_projectManager" type="checkbox" value="project_manager" class="project_exp_chkbx" checked="checked"/>
									<span class="oya-blk">
										 <?php echo __('Project Manager');?>
									</span>
							</label>
					</div>
					<?php // Budget and Cost Approve are not part of the Community Edition. ?>
					<div class="checkbox custom-checkbox pop-task-type-check">
							<label for="exp_project_type">
					...
					<div class="checkbox custom-checkbox pop-task-type-check">
							<label for="exp_industry">
									<input id="exp_industry" type="checkbox" value="project_industry" class="project_exp_chkbx" checked="checked"/>
									<span class="oya-blk">
					...
					<div class="checkbox custom-checkbox pop-task-type-check">
							<label for="exp_customer">
									<input id="exp_customer" type="checkbox" value="project_customer" class="project_exp_chkbx" checked="checked"/>
									<span class="oya-blk">
