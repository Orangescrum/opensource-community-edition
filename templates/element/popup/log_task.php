<style>
    ...
    .cmn-popup table.table th {
        font-weight: 600;
        color: #232323;
    }

    .timeloglist,
    .popup-container .table .form-group {
        margin: 0px 0 0 0;
        padding: 0;
    }
    ...
    .timeloglist,
    .rounded-fild table.table td.td-last .checkbox {
    ...
    .my-modal-page .task-drpdwn-sec {
        align-items: center;
    }

    .logtime-pop .lbe.mylog {
        position: relative;
        top: 4px;
        right: 0%;
    }

    .cmn-popup .modal-content.mymodalcontent .modal-body {
        padding: 0px 24px 10px;
    }

    .lbe.mylog .close.close-icon {
        position: absolute;
        right: -15px;
        top: -25px;
    }
    ...
    .my-modal-page.rounded-fild .modal-content .form-group.label-floating label.control-label {
        position: absolute;
        z-index: 3;
        top: -33px;
        left: 0;
    ...
    .rounded-fild .modal-content .form-group.label-floating label.control-label.log-time-label {
        left: -2px;
        top: -36px;
        color: #232323;
        font-weight: 600;
...
<div class="modal-dialog my-modal-page">
    <!-- Modal content-->
    <div class="modal-content mymodalcontent">
        <div class="modal-header">
            ...
            <div class="projectDropdownTimelog" style="margin-top:5px;">
                <h4 class="mxwid95p fl" style="margin-right:10px;"><?php echo __('Log time');?> - </h4><div class="project-dropdown_log fl" style="width:auto; margin-right: 20px;">
                    <div class="btn-group" style="margin: 0;">
                        ...
                        <?php if(!empty($getallproj) && count($getallproj) === 1){ ?>
                            <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="top_project_btn btn btn_cmn_efect cmn_bg btn-info cmn_size dropdown-toggle project-drop-custom-pad prtl time_log_pp" type="button"  onclick="view_project_menu_popup('timelogpopup','projpopup_log','ajaxViewProjects_log','loader_prmenu_log','popup');">
                            ...
                            $soprjval = $getallproj[0]['Project']['name'] ??'';
                            ?>
                            <input type ="hidden" id="pname_dashboard_hid_log" value="<?php echo $getallproj[0]['Project']['name'] ?? ''; ?>" />
                            <input type ="hidden" id="first_recent_hid_log" value="<?php echo $getallproj['1']['Projects']['name'] ?? ''; ?>" />
                            <input type ="hidden" id="second_recent_hid_log" value="<?php echo $getallproj['2']['Projects']['name'] ?? ''; ?>" />
                            <button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="top_project_btn btn btn_cmn_efect cmn_bg btn-info cmn_size dropdown-toggle project-drop-custom-pad prtl time_log_pp" type="button" onclick="view_project_menu_popup('timelogpopup','projpopup_log','ajaxViewProjects_log','loader_prmenu_log','popup');">
                        ...
                        <div class="dropdown-menu lft popup" id="projpopup_log" style="padding: 0;">
                            ...
                            <div id="find_prj_dv_log" class="pr" style="">
                                ...
                                <div class="form-group is-empty" style="margin-top: 0px;"><input type="text" placeholder="<?php echo __('Find Project');?>" class="form-control pro_srch logsearchid" onkeyup="search_project_menu_popup('popup',this.value,event)" id="search_project_menu_txt_log"><span class="material-input"></span></div>
            ...
            <div class="lbe mylog">
                <ul>
                    <li>
                        <h6><?php echo __('Estimated'); ?>: <span id='logtime_estimated'>---</span></h6>
                    </li>
                    <li>
                        <h6><?php echo __('Logged'); ?>: <span id='logtime_total'>---</span></h6>
                    </li>
                    <li>
                        <h6><?php echo __('Billable'); ?>: <span id='logtime_billable'>---</span></h6>
                    </li>
                    <li>
                        <h6><?php echo __('Non-Billable'); ?>: <span id='logtime_nonbillable'>---</span></h6>
                    </li>
                </ul>
                <button type="button" class="close close-icon clsicons" data-dismiss="modal" onclick="closetskPopup();"><i
        ...
        <div class="modal-body popup-container m640-pop-overflow" id="inner_log" style="display:none;">
            <?= $this->Form->create(null, ['url' => ['controller' => 'Easycases', 'action' => 'addTasklog'], 'id' => 'frmaddlogtim', 'class' => 'media-width700', 'onsubmit' => 'return stvariables();', 'autocomplete' => 'off']) ?>
                ...
                <div class="row d-flex task-drpdwn-sec">
                    <div class="col-lg-9">
                        <div class="pop-dropdown st-pop-drop">
                            <div id="logtsksid">
                            <label style="position: absolute;top: -9px;font-size: 13px;left: 13px;background: white;padding: 0 5px;color:#666"><?php echo __('Select Task'); ?></label>
                                <input type="hidden" id="log_task_id" name="task_id" value="" />
                                <div class="slct_task form-control floating-label custom-tlog-select " style="cursor:pointer;margin-bottom: 27px;margin-top: 27px;" onclick="showLogResults();"><span><?php echo __('Select task to log time');?></span>
                                ...
                                <div class="hide logResult">
                                    <div id="searchQuickTask" class="pr margin-top-0">
                                        ...
                                        <div class="form-group is-empty">
                                            <input type="text" placeholder="<?php echo __('Search Tasks');?>" id="log_search" class="form-control pro_srch logsearchid" onkeyup="searchLogTask();">
                    ...
                    <div class="col-lg-3">
                        ...
                        <label>
                            ...
                            <?php echo __('Skip Time Duration'); ?>
                            </label>
                        </span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="popup-inner-container">
                                ...
                                <tr id="ul_timelog1">
                                    <td style="width:280px;">
                                        <div class="resource-select">
                                            <select id="whosassign1" name="user_id[]" class=""><option value=""><?php echo __('Select User');?></option></select>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="form-group" style="width:83px;">
                                    ...
                                    <td class="td-last">
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <a href="javascript:void(0);" onClick="removeUI(1);" id="crsid1" class="crsid" style="display:none;"><i class="material-icons" style="font-size: 20px;"></i></a>
                                            </label>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <p class="plus-btn">
                                <a href="javascript:void(0)" onclick="appendnewrow();" class="append-new-row blue-txt"><i class="material-icons">&#xE145;</i><?php echo __('Add line-item');?></a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group form-group-lg label-floating">
                    <label class="control-label tskdesc-lbl log-time-label" for="tskdesc">Add a note</label>
                ...
                <div class="text-left cmn_foot_cont fl" id="projectaccess_log" style="margin-bottom: 10px; font-size:12px;" ></div>
        ...
        $( "#frmaddlogtim" ).off().on( "blur", ".totalduration", function() {
            if($('#skip_timeDuration').is(":not(:checked)")){
                ...
                if(sttime !=''){
                    ...
                    var generaged_end_min = generaged_end_min.toLocaleString('en-US',{
                ...
                if(response.success){
                    ...
                    setTimeout(function(){ //Settimeout function is required to sleep th epage so that event tracking can be easily insert into database
                        ...
                        if(getHash() == 'timelog' && !$("#myModalDetail").hasClass('in')){
                            ajaxTimeLogView();
                        }else if(getHash() == 'backlogByStatus'){
...
//                                }
    ...
    function appendnewrow(){
        ...
        $("#workeddt"+cntr).datepicker("setDate", moment(new Date()).format('MMM DD, YYYY'));
        ...
        if(rsrch == ""){
            if(SES_TYPE < 3){
                ...
                $.each(TLUSER, function (k1, v1) {
                    var usrid = v1['User']['id'];
                    var selected = (usrid===SES_ID)?"selected='selected'":"";
                    usrhtml += "<option value='" + usrid + "' " + selected + ">" + v1['User']['name'] + " " + v1['User']['last_name'] + "</option>";
                });
            }else if(SES_TYPE == 3){
                /*
                $.each(PUSERS, function (key, val) {
