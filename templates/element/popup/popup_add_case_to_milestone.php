    ...
    <div class="modal-content">
        ...
        <div class="modal-body popup-container" style="">
            ...
            <div id="tsksrch"  class="col-lg-4 padlft-non padrht-non form-group  label-floating fr" style="display:none;">
                <label class="control-label" for="tsk_name_milestone" style="line-height: 1.07142857;background: white;top:-24px;"><?php echo __('Task Title');?></label>
                <?php echo $this->Form->text('name', ['class' => 'form-control', 'id' => 'tsk_name_milestone', 'maxlength' => '100', 'onkeyup' => 'searchMilestoneCase()']); ?>
