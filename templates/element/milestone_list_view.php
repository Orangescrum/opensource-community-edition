<div class="milestone_side_view_main">
	<div class="milestone_slide_toggle"><?php echo __('Task Groups'); ?></div>
	<div class="milestone_side_view">
		...
		<div class="milestone_side_view_container">
			<div class="search_box">
				...
				<input type="text" placeholder="Search" class="" id="milestone_search"
					onkeyup="searchMilestoneItems(this, event);">
