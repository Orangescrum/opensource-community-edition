            ...
            <div class="task-detail-head task_details_title fw_tskdtail_head <%= protyCls %>">
                <h5>
                    ...
                    <div id="case_ttl_edit_main_<%= csUniqId %>" class="wrapword fs-hide removeLinks" onmouseover="displayEdit(<%= '\''+csUniqId+'\'' %>,1);" onmouseout="displayEdit(<%= '\'' +csUniqId+ '\'' %>,0);">
                        <div <% if(user_can_change == 1){ %>class="task_title_hover" style="float:left;" id="case_ttl_edit_spn_<%= csUniqId %>" title="<?php echo __('Edit Task Title'); ?>" rel="tooltip" <% }else{ %>style="float:left;" <% } %>>#<%= csNoRep %>: <%= formatText(ucfirst(caseTitle)) %> <span class="relative sub-tasks sub-tasks-popoup"><%= easycaseTitle %></span></div>
                        <div class="cb"></div>
                    </div>
                                ...
                                <div class="time_log_reply task-details-tlog" id="reply_time_log<%= csAtId %>">
                                    ...
                                    <div class="tlog_top_cnt">
                                        <div class="time-log-header timelog-table timelog-table-head <% if(SHOWTIMELOG !='No' && pagename == 'taskdetails'){ %>detail_timelog_header<% } %>" style="<% if(SHOWTIMELOG !='No' && pagename == 'taskdetails'){ %>display:none;<% } %>">
                                            <a class="<%=logtimes.page%> anchor log-more-time fr" onclick="startTimer(<%= '\'' + logtimes.task_id + '\'' %>,<%= '\'' + escape(htmlspecialchars(logtimes.task_title,3)) + '\'' %>,<%= '\'' + logtimes.task_uniqId + '\'' %>,<%= '\'' + logtimes.project_uniqId + '\'' %>,<%= '\'' + escape(logtimes.project_name) + '\'' %>)"><i class="material-icons">&#xE425;</i><?php echo __('Start Timer'); ?></a>
                                            <a class="<%=logtimes.page%> anchor log-more-time fr" onclick="createlog(<%= logtimes.task_id %>,'<%= escape(htmlspecialchars(logtimes.task_title))%>')"><i class="material-icons">&#xE192;</i><?php echo __('Time Entry'); ?></a>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                    <% } %>
            ...
            <div class="col-lg-12 col-sm-12 padlft-non padrht-non">
                <div class="task-detail-rht">
                    <div class="cmn_sec_head">
                        <div class="sec_ttl">
                            <h5><span class="cmn_tskd_sp user_icon"></span><?php echo __('People'); ?></h5>
                        </div>
                    ...
                    <div class="cmn_sec_head">
                        <div class="sec_ttl">
                            <h5><span class="cmn_tskd_sp date_icon"></span><?php echo __('Date'); ?></h5>
                        </div>
                    ...
                    <div class="cmn_sec_head">
                        <div class="sec_ttl">
                            <h5><span class="cmn_tskd_sp file_icon"></span><?php echo __('File in this Task'); ?></h5>
                        </div>
                        <div class="file_in_task">
                            ...
                            <div class="added-task-file">
                                ...
                                <div class="cb"></div>
                                <% } %>
                                <% if(fc==0) { %><p class="fnt12px nofiletxt colr_red"><?php echo __('No Files in this Task'); ?></p>
                                <div class="cb"></div><% } %>
                            </div>
                        </div>
                    </div>
                    <div class="cmn_sec_head">
                        <div class="sec_ttl">
                            <h5><span class="cmn_tskd_sp activity_icon"></span><?php echo __('Activities'); ?></h5>
                        </div>
