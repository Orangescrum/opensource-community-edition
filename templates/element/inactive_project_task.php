...
%>
            ...
            <div id="widgethideshow" class="fl task-list-progress-bar fix-status-widget" <?php if (strtotime("+2 months", strtotime(CMP_CREATED)) >= time()) { ?><?php } ?>>
                ...
                <span id="task_view_types" style="float:right;display:block;margin-top:-4px">
                    <ul class="new_icon_on_list_top">
                        <li>
                            <a class="" href="<?php echo HTTP_ROOT; ?>dashboard#calendar" onclick="return calendarView(<%= '\'calendar\'' %>);">
                                <span title="<?php echo __('Calendar'); ?>" rel="tooltip"><i class="material-icons">&#xE916;</i></span>
                            </a>
                        </li>
                        <?php
                        $kanbanurl = "";
                        ...
                        ?>
                        <li>
                            <a class="" href="<?php echo HTTP_ROOT; ?>dashboard#<?php echo $kanbanurl; ?>" onclick="return checkHashLoad(<%= '\'<?php echo $kanbanurl; ?>\'' %>);">
                                <span id="kbview_btn" class="" title="<?php echo __('Kanban'); ?>" rel="tooltip">
                                    <i class="material-icons">&#xE8F0;</i>
                                </span>
                            </a>
                        </li>
                        <% if(GrpBy != 'milestone'){ %>
                        <li><a class="" href="javascript:void(0);" onclick="groupby(<%= '\'milestone\'' %>, event,1);">
                                <span title="<?php echo __('Task Group'); ?>" rel="tooltip"><i class="material-icons">&#xE065;</i></span>
                            </a>
                        </li>
                        <% } %>
                        <% if(GrpBy == 'milestone'){ %>
                        <li>
                            <a class="" href="<?php echo HTTP_ROOT; ?><%= '\'dashboard#tasks\'' %>" onclick="checkHashLoad(<%= '\'tasks\'' %>);">
                                <span title="<?php echo __('List'); ?>" rel="tooltip"><i class="material-icons">&#xE896;</i></span>
                            </a>
                        </li>
                        <% } %>
                        <li>
                ...
                <thead>
                    <tr>
                        ...
                        <% 
                            ...
                            %>
                        <th class="tsk_due_dt">
                            <a class="sortduedate" href="javascript:void(0);" title="<?php echo __('Due Date'); ?>" onclick="inactiveAjaxSorting(<%= '\'duedate\', ' + caseCount + ', this,'+orderDuDt %>);">
                                Due Date
                            ...
                            <div class="form-group label-floating">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-fab btn-fab-mini quick-send-icon" onclick="AddQuickTask(); " title="<?php echo __('Post Task'); ?>">
			...
			<% } %>
                        ...
                        <td class="due_dt_tlist">
                            <div class="<% if(getdata.Easycase.csDueDate == '' || getdata.Easycase.legend == 5 || getdata.Easycase.type_id == 10 || getdata.Easycase.legend == 3){ %> <% } %>">
                                ...
                                <span class="" <% if(showQuickActiononList){ %>title="<?php echo __('Edit Due Date'); ?>" <% } %>></span>
                                <% } %>
        ...
        <div class="task-m-overflow">
            <table class="table table-striped table-hover compactview_tbl">
                        ...
                        <td colspan="3">
                            <div class="form-group label-floating">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-fab btn-fab-mini" onclick="AddNewMilestone();" title="<?php echo __('Post Task'); ?>">
                ...
                <tbody>
                    <tr class="tgrp_tr_all task_group_accd" id="empty_milestone_tr<%= all_milesto_names[mkey]['id'] %>" data-pid="<%= all_milesto_names[mkey]['project_id']%>">
                        <td colspan="10" class="pr">
                            ...
                            <div class="plus-minus-accordian">
                                ...
                                <div class="fl taskgroup-pencil <% if(all_milesto_names[mkey]['id'] > 0){ %> <%='showEditTaskgroup'+ all_milesto_names[mkey]['id'] %> <% }else{ %> <%='showEditTaskgroupdefault' %><% } %>" <% if(all_milesto_names[mkey]['id'] > 0){ %> onclick="showhideinlinedit( <%= all_milesto_names[mkey]['id'] %> );" <% }else{ %> onclick="showhideinlinedit(<%= '\'default\'' %>);" <% } %>>
                    ...
                    <tr class="empty_task_tr">
                        <td></td>
                        <td colspan="10" align="center" class="textRed"><?php echo __('No Tasks found'); ?></td>
                    </tr>
                </tbody>
                <% } %>
                <% } %>
	...
	%>
        ...
        <tr class="list-dt-row">
            <td colspan="9" align="left" class="curr_day">
                <div class="dt_cmn_mc <% if(count!=1 && !getdata.Easycase.pjname) {%>y_day<% } %>"><%= getdata.Easycase.newActuldt %></div>
            </td>
        </tr>
        <%	}} %>
