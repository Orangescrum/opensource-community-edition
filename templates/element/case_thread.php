            ...
            <div id="cnt_<%= getdata.thread_count %>"class="details_task_desc wrapword" style="overflow:hidden;">
                    ...
                    <div class="cb"></div>
                            ...
                            <% caseFileName = getFiles.CaseFile.file;
                                ...
                                oneDriveMetaAvailable = getFiles.CaseFile.hasOwnProperty('OneDriveMeta') && getFiles.CaseFile.OneDriveMeta && getFiles.CaseFile.OneDriveMeta.embedLink ? true : false;
