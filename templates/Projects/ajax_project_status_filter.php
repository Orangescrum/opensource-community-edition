              ...
              <li style="display: block;">
                <a href="javascript:void(0);">
                    <div class="slide_menu_div1 ellipsis-view">
                        ...
                        <label class="cmn_filter_label" for="dprojstatusmange_<?php echo $drbId; ?>" onClick="checkboxProjectStatus('dprojstatusmange_<?php echo $drbId; ?>', 'check','<?php echo $drbId; ?>','<?php echo $this->Format->formatText($drbTitle); ?>');"   title='<?php echo $this->Format->formatText($drbTitle); ?>'>
