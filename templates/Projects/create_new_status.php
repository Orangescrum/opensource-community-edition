            ...
            <div class="form-group label-floating">
                ...
                <select name="data[CustomStatus][status_master_id]" class="select2" id="custom_statuses_map">
                    <?php foreach ($statusMaster as $k => $v) { ?>
                        <option value="<?php echo $k; ?>" <?php if (isset($res['CustomStatus']['status_master_id']) && $res['CustomStatus']['status_master_id'] == $k) {
                               echo 'selected="selected"';
                           } else if (!isset($res['CustomStatus']['status_master_id']) && $k == 2) {
                               echo 'selected="selected"';
                           } ?> <?php if (isset($res['CustomStatus']['status_master_id']) && $res['CustomStatus']['status_master_id'] == 3 && $k != 3) {
        ...
        <div class="fr popup-btn">
            ...
            <span id="wfbtn1">
                ...
                <span class="fl hover-pop-btn">
                    ...
                    <input type="button" id="newworkflow_btn" value="<?php if(isset($res['CustomStatus']['id']) && !empty($res['CustomStatus']['id'])){ echo __('Update'); }else{ echo __('Add'); } ?>" name="add" class="btn btn_cmn_efect cmn_bg btn-info cmn_size"  <?php if($from_page != ''){ ?>
