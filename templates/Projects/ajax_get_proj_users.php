...
<div class="scrl-ovr">
    ...
    <?php if (!empty($memsExtArr['Member']) || !empty($memsExtArr['Invited']) || !empty($memsExtArr['Disabled'])) { ?>
        <span id="hid_ext_use_lbl" style="display: none;"><?php echo $extusers; ?> <?php echo __('has open tasks.') . ' ' . __('Assign these tasks to others or left them unassigned'); ?></span>
