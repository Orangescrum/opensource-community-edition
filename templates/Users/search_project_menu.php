...
} else if ($fres == 1 && ($page == 'reports' || $page == 'hoursReport' || $page == 'chart')) {
    $pgname = $page;
    if (isset($allProjArr) && count($allProjArr)) {
        $i = 0; $colrs = "";
        foreach ($allProjArr as $proj) {
            ...
            <?php } else if ($pgname == 'hoursReport') { ?>
...
} else if (($fres == 1) && ($page == 'popup' || $page == 'subtaskPopup' || $page == 'defect')) {
    if (isset($allProjArr) && count($allProjArr)) {
        $i = 0;
        $colrs = "";
        foreach ($allProjArr as $proj) {
            ...
            $colrs = "";
            ?>
            <a href="javascript:jsVoid();" class="proj_lnks ttc " onclick="<?php if($page == 'subtaskPopup' || $page == 'defect'){ ?>
