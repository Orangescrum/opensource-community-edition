...
<div class="get_started_outer">
	...
	<!-- <span style="float:right;">Need Help? <a href="https://helpdesk.orangescrum.com/cloud/" target="_blank">Click here!</a></span> -->
    ...
    <div class="get_det">
        <div class="fl get_img get_prj_bg" onclick="newProject();">
						<div class="gsm-icon gs-proj"><i class="material-icons">&#xE8F9;</i></div>
        </div>
        <div class="get_text fl">
            <div class="get_title"><?php echo $this->Html->link('Create and Assign Project','javascript:void(0);',array('onclick'=>'newProject();','class'=>''));?> <?php echo !empty($projects)?$this->Html->image('yes.png'):'';?> </div>
            <ul>
                <li>
                    Name your project suitably, choose short name accordingly.
                </li>
                <li>
                    Add up your team members to the project while creating.
                </li>
                <li>
                    Alternately, you can add team members to a project in 'Manage Projects' section.
                </li>
            </ul>
        </div>
        <div class="cb"></div>
...
<?php } ?>
    ...
    <div class="get_det">
        <div class="fl get_img get_tsk_bg"   <?php if($this->Format->isAllowed('Create Task',$roleAccess) || SES_TYPE ==1){ ?>    onclick="creatask();" <?php } ?>>
 ...
 <?php if($this->Format->isAllowed('Create Task',$roleAccess) || SES_TYPE ==1){ ?>    
            ...
            echo $this->Html->link('Create','javascript:void(0);',array('onclick'=>'creatask();','class'=>'get_title'));
            }else{
...
?> <?php } ?> <?php echo (!empty($tasks) && !empty($invitations) && !empty($projects) )?$this->Html->image('yes.png'):'';?></div>
     ...
     <div class="get_hd_bg" onclick="window.location='<?php echo HTTP_ROOT; ?>task-type'"><?php echo __('Custom Task Type'); ?></div>
    <div class="get_det">
        <div class="fl get_img custom_taskn" onclick="window.location='<?php echo HTTP_ROOT; ?>task-type'">
            <div class="gs-email">
            	Custom<br/><?php echo __('Task Type'); ?>
            </div>
        </div>
        <div class="get_text fl">
    ...
    <?php } ?>
    <?php if(isset($respondviaemail)) { ?>
    /* Respond via Email section */
