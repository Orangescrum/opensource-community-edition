<?php if (isset($gettodos_overview) && !empty($gettodos_overview)) { ?>
    ...
    <div class="scroll_body">
        <table>
            <tbody>
                <?php foreach ($gettodos_overview as $key => $value) {
                    if ($value['assign_to'] == 0) {
                        $value['Users']['name'] = __('Unassigned');
                    } ?>
                    <tr>
                        <td>
                            <div class="user_name">
                                <span class="pfl_img">
                                    <span rel="tooltip" title="<?php echo ucfirst($value['Users']['name'] . ' ' . $value['Users']['last_name']); ?>">
                                        <?php if ($value['Users']['photo']) { ?>
                                            <img src="<?php echo HTTP_ROOT; ?>users/image_thumb/?type=photos&file=<?php echo $value['Users']['photo']; ?>&sizex=30&sizey=30&quality=100" title="<?php echo $value['Users']['name']; ?>" rel="tooltip" alt="<?php echo __('Loading'); ?>" />
                                        <?php } else {
