...
$json_data = [];
$closed = 0;
$legend = [1 => __("New"), 2 => __("In-Progress"), 3 => __("Closed"), 4 => __("Start"), 5 => __("Resolved"), 6 => __("Modified"), 10 => __("Modified")];
$color = [1 => "#F2520D", 2 => "#8DC2F8", 3 => "#2a9d90", 4 => "#634972", 5 => "#e8c468", 6 => "#FFF363", 10 => "#c2c2c2"];
