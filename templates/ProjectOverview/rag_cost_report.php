...
<?php
$type = ['costapproved' => __('Cost Approved'), 'costtoclient' => __('Cost To Client'), 'costtocompany' => __('Cost To Company')];
...
?>
    <tr>
        <td colspan="7">
            <div class='mytask_txt'><?php echo __("Oops!No activity in last week! What's cooking"); ?> ?</div>
        </td>
    </tr>
<?php }  ?>
        ...
        <tbody>
            ...
            if (!empty($projects)) { #echo "<pre>";print_r($projects);exit;
                foreach ($projects as $k => $val) {
                    ...
                    $clnt_cmnpy_name = !empty($val['client_company_name']) ? $val['client_company_name'] : __('None');
            ?>
                ...
                <tr>
                    <td colspan="5">
                        <div class='mytask_txt colr_red text-center font16'><?php echo __("Oops!No activity in last week! What's cooking"); ?> ?</div>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
