<div class="popup-inner-container scrl-ovr">
		...
		<?php
		    ...
		    <tr valign="middle">
    		    <td colspan="7" style="text-align: center;">
			        <span class="fnt_clr_rd" ><?php echo __('No task(s) available');?>.</span>
		        </td>
		    </tr>
	    <?php } ?>
    </table>
    <input type="hidden" id="addcsmlstn" value="<?php echo urlencode($this->Format->shortLength($this->Format->formatText($milestone['title']), 20)); ?>" />
    <input type="hidden" id="addcsmlstn_titl" value="<?php echo $this->Format->shortLength($this->Format->formatText($milestone['title']), 20); ?>" />
    <input type="hidden" id="addcsmlstn_full_titl" value="<?php echo $this->Format->formatText($milestone['title']); ?>" />
    ...
    <input type="hidden" name="countmanage" id="countmanage" value="<?php echo $countmanage ?? 0; ?>"/>
    <input type="hidden" name="user_id" id="user_id" value="<?php echo $milestone['user_id']; ?>"/>
