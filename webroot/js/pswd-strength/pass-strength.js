...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append('<input type="password" id="'+fieldId+'" name="newpass" placeholder="Set your password"  maxlength=30 autocomplete="off" class="inp_fld ' + options.inputClass + '" "/>');
        this.element.append('<input type="text" id="'+fieldId+'_txt" name="newpass" placeholder="Set your password"  maxlength=30 autocomplete="off" class="inp_fld ' + options.inputClass + '" style="display:none"/>');
