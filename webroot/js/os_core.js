...
return s.join(dec);}
function htmlspecialchars(string,quote_style,charset,double_encode){ if(!string) {return '';} var optTemp=0,i=0,noquotes=false;if(typeof quote_style==='undefined'||quote_style===null){quote_style=2;}
