...
$(function () {
	...
	$('#file_upload_epic').fileUploadUI({
		uploadTable: $('#up_files_epic'),
		downloadTable: $('#up_files_epic'),
		buildUploadRow: function (files, index) {
			var filename = files[index].name;
			var fname = filename.toLowerCase();
	...
	$('#file_upload_feature').fileUploadUI({
		uploadTable: $('#up_files_feature'),
		downloadTable: $('#up_files_feature'),
		buildUploadRow: function (files, index) {
			var filename = files[index].name;
			var fname = filename.toLowerCase();
